<div>
    <div class="card">
        <div class="card-header border-bottom d-flex justify-content-between">
            ...
            <a class="btn btn-primary h-50" href="{{ route('tournaments') }}">Tournament</a>
            ...
            <table class="datatables-matches dataTable table border-top">
                ...
                @foreach($matches as $match)
                    <tr>
                        ...
                        <td>
                            @can('matches-view')
                                <a href="{{ route('matches.view', ['id' => $match->id, 'status' => '1']) }}" class="text-body view-user-button"><i class="ti ti-eye ti-sm me-2"></i></a>
