...
{{$point->created_at}}
{{$point->home_team_score}}
{{$point->away_team_score}}
        ...
        <div class="layout-page">
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="py-3 mb-4"><span class="text-muted fw-light">Extended
                  UI /</span> Fullscreen Timeline</h4>
                  ...
                  <ul class="timeline timeline-center mt-5">
                      ...
                      <div class="timeline-event card p-0"
                        ...
                        <div class="card-body">
                          <p class="mb-2">
                            ...
                            for our client. The customer wants a
                            clean & flat design.
                          </p>
                          <div
                      ...
                      <div class="timeline-event card p-0" data-aos="fade-left">
                        ...
                        <div class="card-body">
                          <div class="d-flex flex-wrap mb-4">
                            ...
                            <span>assigned this task to <span
                    ...
                    <li class="timeline-item">
                      ...
                      <div class="timeline-event card p-0"
                        ...
                        <div class="card-body">
                          <p class="mb-2">Click the button below to read
                            financial reports</p>
                          <button
                        ...
                        <div class="card-body">
                          <div class="d-flex flex-sm-row flex-column">
                            <img
                              ...
                              width="64" />
                            <div>
                              <h6 class="mb-2">A Donut which straight gone to
                                Your Tummy</h6>
                              <p class="mb-2">
                                I gaze longingly at the beautiful, perfect,
                                plump donut. This is a delicately crafted
                                piece of art. The mouthwatering mound of
                                miraculous mush isn't able to escape my
                                sight...<a href="javascript:void(0)">read
                                  more</a>
                              </p>
                              <div
                    ...
                    <li class="timeline-item timeline-item-right">
                      ...
                      <div class="timeline-event card p-0" data-aos="fade-left">
                        <div
                          ...
                          <span
                            class="badge rounded-pill bg-label-danger">High</span>
                        </div>
                        <div class="card-body py-0">
                          <h6 class="mb-2">Final location for the company
                            celebration.</h6>
                        ...
                        <div class="card-footer d-flex justify-content-between">
                          <div
                            class="d-flex align-items-center flex-wrap cursor-pointer gap-3">
                    ...
                    <li class="timeline-item timeline-item-left">
                      ...
                      <div class="timeline-event card p-0"
                        ...
                        <div class="card-footer d-flex justify-content-between">
                          <div class="tags">
                            <span
                              class="badge rounded-pill bg-label-danger">Gym</span>
                            <span
                              class="badge rounded-pill bg-label-info">Power</span>
                          </div>
                          <div>
                            <i
                              class="ti ti-dots-vertical text-muted cursor-pointer"></i>
                          </div>
                        </div>
                      ...
                      <div class="timeline-event card p-0"
                        ...
                        <div class="card-body">
                          <ul class="list-unstyled">
                            ...
                            <li
                              class="d-flex justify-content-start align-items-center text-info mb-3">
                              <i class="ti ti-credit-card ti-sm me-3"></i>
                              <div class="ps-3 border-start">
                                <small class="text-muted mb-1">Credit
                                  Card</small>
                            ...
                            <li
                              ...
                              <div class="ps-3 border-start">
                                <small
                                  class="text-muted mb-1">Investments</small>
                    ...
                    <li class="timeline-item">
                      ...
                      <div class="timeline-event card p-0" data-aos="fade-left">
                        <div
                          ...
                          <span
                            class="badge rounded-pill bg-label-danger">Inactive</span>
                        </div>
                      ...
                      <div class="timeline-event card p-0"
                        ...
                        <div
                          ...
                          <h6 class="card-title mb-0"><span
                              class="align-middle">Online Store</span></h6>
                          <i
                            class="ti ti-dots-vertical text-muted cursor-pointer"></i>
                        </div>
                        <div class="card-body pt-0">
                          <p>
                            ...
                            the provided layout, as well as develop a
                            mobile version of it. The must be compatible with
                            any CMS.
                          </p>
