        ...
        <div class="col-xl">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">{{ $editing ? ($status == \App\Utils\Constants::VIEW_STATUS ? "View" : ($status == \App\Utils\Constants::CONFIRM_STATUS ? "Confirm" : "Edit")) : "Create" }} User</h5>
                    <a href="{{ route('users') }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-password-toggle">
                                ...
                                <div class="input-group">
                                    ...
                                    />
                                    <span id="basic-default-password-confirmation2" class="input-group-text cursor-pointer"
                                    ><i class="ti ti-eye-off"></i
                                        ></span>
                                </div>
                            </div>
