<div>
    <div>
        <div class="d-flex justify-content-between">
            <div>
                <h4 class="fw-semibold">Roles List</h4>
                <p>
                    A role provides access to predefined menus and features so that an administrator can have access depending on the assigned role.
                </p>
            </div>
