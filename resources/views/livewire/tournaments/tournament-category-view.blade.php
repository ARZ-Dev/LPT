                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('knockoutStage.view', $tournament->id) }}" class="text-body m-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Knockout Stages"><i class="ti ti-article ti-sm"></i></a>
