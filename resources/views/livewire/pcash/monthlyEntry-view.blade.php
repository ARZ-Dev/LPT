<div>
    ...
    <div class="card">
        <div class="card-header border-bottom d-flex justify-content-between">
            ...
            <a class="btn btn-primary h-50" href="{{ route('monthlyEntry.create') }}">Add Monthly Entry</a>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @can('monthlyEntry-edit')
                                <a href="{{ route('monthlyEntry.edit', $monthlyEntry->id) }}" class="text-body edit-user-button"><i class="ti ti-edit ti-sm"></i></a>
                            @endcan
