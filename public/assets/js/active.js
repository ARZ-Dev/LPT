(function ($) {
    ...
    const originCarousel = new Swiper('.origin-carousel', { 
        spaceBetween: 15,
        initialSlide: 0,
        loop: false, 
        navigation: {
            nextEl: '.origin-carousel .swiper-button-next',
            prevEl: '.origin-carousel .swiper-button-prev',
        },
        breakpoints: {
            320: {
                slidesPerView: 'auto'
    ...
    // originCarousel.update(true);

    // originCarousel.on('slideChange', function () { alert("!");
    //     originCarousel.update(true);
    // });
